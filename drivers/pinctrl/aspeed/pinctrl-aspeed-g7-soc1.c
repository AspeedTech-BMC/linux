...
GROUP_DECL(JTAGM1, F10, E11, F11, F13);
GROUP_DECL(JTAGM1TRST, D12);
...
GROUP_DECL(CANBUS, G8, G9);
GROUP_DECL(CANBUSSTBY, G7);
...
static struct aspeed_pin_group aspeed_g7_soc1_pingroups[] = {
	...
	ASPEED_PINCTRL_GROUP(JTAGM1TRST),
	...
	ASPEED_PINCTRL_GROUP(CANBUSSTBY),
...
FUNC_DECL_(JTAGM1, "JTAGM1", "JTAGM1TRST");
...
FUNC_DECL_(CANBUS, "CANBUS", "CANBUSSTBY");
...
FUNCFG_DESCL(D12, PIN_CFG(JTAGM1TRST, SCU440, GENMASK(10, 8), (1 << 8)));
...
FUNCFG_DESCL(G7, PIN_CFG(I2C9, SCU45C, GENMASK(14, 12), (1 << 12)),
	     PIN_CFG(CANBUSSTBY, SCU45C, GENMASK(14, 12), (2 << 12)),
